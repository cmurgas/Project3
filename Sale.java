...
public class Sale
{
    ...
    * @param soldTo String name of whom the Sales Associate makes the sale to
    */
    ...
    */
   public ArrayList<String> getPartNames() {return partNames; }
   /**
    * getAmounts method returns the amounts of parts sold
    * @return amounts ArrayList
    */
   public ArrayList<Integer> getAmounts() { return amounts; }
   /**
    ...
    */
   public SalesAssociate getSoldBy() { return soldBy; }
   /**
    * getSoldTo method returns the name of the person who bought the items
    * @return soldTo String
    */
